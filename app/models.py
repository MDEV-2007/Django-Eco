...
class Category(models.Model):
    ...
    created_at = models.DateTimeField('Data Add', auto_now_add=True)
...
class Product(models.Model):
    ...
    price = models.DecimalField(
        "Price", max_digits=7, decimal_places=2, default=9.99)
    image = models.ImageField(
        "Chose", upload_to='images/products/%Y/%m/%d', default='products/products/default.jpg')
    available = models.BooleanField("available", default=True)
    created_at = models.DateTimeField('Data Add', auto_now_add=True, db_index=True)
    updated_at = models.DateTimeField('Update Data Add', auto_now=True)
